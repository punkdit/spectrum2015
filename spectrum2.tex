...
We show how to apply group representation theory to
block diagonalize the Hamiltonion, with blocks labelled
by stabilizer eigenvalues.
In the case when the Hamiltonion is stoquastic, we apply
Perron-Frobenius theory to constrain the location of the
second eigenvector.
\end{abstract}
