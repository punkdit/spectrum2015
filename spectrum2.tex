...
\subsection{Symplectic structure of CSS gauge codes}\label{Sec36}
...
\subsection{Commuting ideal structure of gauge codes}\label{Sec45}
...
will anti-commute only when they intersect on a single vertex.
...
These results are crucial for obtaining the exact
