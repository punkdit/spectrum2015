...
the set $R_X$, or given $v\in F_2^r$ then $u = R_X v^\top$ is
...
I.
$$
%The rows of the matrix are linearly
%independant.
This again is a presentation of the Pauli group.
...
with the wavefronts being identified with so-called Cheeger cuts.
...
\subsection{On the gap}

We first consider a linear graph Hamiltonian
