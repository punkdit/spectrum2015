...
either a set of $\Fn$ vectors (the rows) or as an 
...
This is a set of 16 equations, quadratic in the unknown variables,
...
Starting with the $t_X=0, t_Z=0$ irrep,
